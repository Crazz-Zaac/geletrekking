...
export default function AdminGallery() {
  ...
  async function saveHeroImage() {
    ...
    try {
      ...
      setMsg(e?.response?.data?.message || e.message || "Failed to update hero image");
    } finally {
      ...
      <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="rounded-lg bg-sky-500 hover:bg-sky-600 disabled:bg-slate-600 px-4 py-2 font-semibold"
          >

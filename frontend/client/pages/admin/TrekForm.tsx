...
export default function TrekForm() {
  ...
  const addInclude = () => {
    ...
    showToast.success("Include item added");
  };
  ...
  const removeInclude = (index: number) => {
    ...
    showToast.success("Include item removed");
  };

  // EXCLUDES
  const addExclude = () => {
    setExcludes([...excludes, ""]);
    showToast.success("Exclude item added");
  };
  ...
  const removeExclude = (index: number) => {
    ...
    showToast.success("Exclude item removed");
  };
  ...
  const addItineraryDay = () => {
    ...
    showToast.success("Itinerary day added");
  };
  ...
  const removeItineraryDay = (index: number) => {
    ...
    showToast.success("Itinerary day removed");
  };
  ...
  const addExtraSection = () => {
    ...
    showToast.success("Extra section added");
  };
  ...
  const removeExtraSection = (index: number) => {
    ...
    showToast.success("Extra section removed");
  };

  const handleSubmit = async () => {
    if (!form.name.trim()) {
      showToast.error("Trek name is required!");
      return;
    }
    if (!form.overview.trim()) {
      showToast.error("Overview is required!");
      return;
    }
    ...
    try {
      ...
      if (isEditMode) {
        ...
        showToast.success("Trek created successfully!");
      }
      navigate("/admin/treks");
    } catch (err: any) {

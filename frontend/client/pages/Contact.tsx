        ...
        <section className="pt-32 pb-16 bg-gradient-to-br from-blue-50 to-teal-50">
          <div className="container mx-auto px-4">
            ...
            <p className="text-lg text-gray-600 max-w-2xl">
              Get in touch with GELE TREKKING for your next adventure in the Himalayas.
            </p>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  {submitMessage && (
                    <div className={`p-4 rounded-lg ${submitMessage.includes('Thank') ? 'bg-green-50 text-green-800' : 'bg-red-50 text-red-800'}`}>
                      {submitMessage}
                    </div>
                  )}
              ...
              <div>
                ...
                <div className="rounded-xl overflow-hidden shadow-lg border border-gray-200">
                  <iframe
                    ...
                    title="GELE TREKKING Office Location"
                    className="w-full"
                  />
                </div>
                ...
                <div className="mt-6 space-y-4 bg-gray-50 p-6 rounded-xl">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">
                        Tarkeshowr-7, Kathmandu<br />
                        Nepal
                      </p>
                      <p className="text-xs text-gray-500 mt-1">
                        27°45'32.0"N 85°18'30.0"E
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <a href="mailto:ldawa9808@gmail.com" className="text-blue-600 hover:text-blue-700 hover:underline text-sm">
                        ldawa9808@gmail.com
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <a href="tel:+97715922345" className="text-blue-600 hover:text-blue-700 hover:underline text-sm">
                        +977 01-5922345
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-900 mb-1">WhatsApp / Viber</h3>
                      <a href="https://wa.me/97715922345" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-700 hover:underline text-sm">
                        +977 01-5922345
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="pt-4">
                    <a
                      ...
                      className="inline-flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-lg transition-colors w-full"
                    >
        ...
        <section className="py-16 bg-gradient-to-br from-blue-600 to-teal-600 text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-lg text-blue-100 mb-8 max-w-2xl mx-auto">
              Join thousands of satisfied trekkers who have explored the Himalayas with GELE TREKKING
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="tel:+97715922345"

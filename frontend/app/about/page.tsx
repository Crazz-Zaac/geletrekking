        ...
        <section className="py-12 md:py-16 bg-gradient-to-r from-primary/10 to-accent/10 border-b border-border">
          <div className="container mx-auto px-4 md:px-6">
            ...
            >
              ...
              >
                We are a Nepal-based trekking company focused on safe, authentic, and responsibly operated Himalayan experiences.
              </motion.p>
            </motion.div>
          </div>
        </section>
              ...
              <motion.div variants={containerVariants} className="lg:col-span-8 space-y-6">
                <motion.div variants={itemVariants}>
                  <Card className="border-border p-6 md:p-7">
                    <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-3">Our Story</h2>
                ...
                <motion.div variants={itemVariants}>
                  <Card className="border-border p-6 md:p-7">
                    <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-3">Our Mission</h2>
                    <p className="text-muted-foreground leading-relaxed">
                      ...
                      <Card key={review.id} className="relative border-border p-5 bg-gradient-to-br from-background to-muted/30">
                        ...
                        <div className="flex items-center justify-between gap-3">
                          <div>
                            ...
                            <p className="text-xs text-muted-foreground">{review.country} • {review.trek}</p>
                          </div>
                          <span className="text-[11px] font-medium px-2 py-1 rounded-full bg-primary/10 text-primary">{review.date}</span>
                        </div>
                      </Card>
                    ))}
                  </div>
